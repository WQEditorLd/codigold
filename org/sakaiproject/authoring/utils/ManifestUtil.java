 ...
 * ManifestUtil 
 * 
 * Classe acessória para acionamento do JAXB para leitura e gravação do arquivo XML no formato IMS CP & IMS LD
 * 
 * Revisão 1.0WQ - 15/04/2010 - Remoção dos métodos utilitários referentes ao Grafo (Graph), @see GraphUtil 
 */
