...
public class RolePartSelectionModel extends TableSelectionModel<RolePart> {
	...
	public RolePartSelectionModel(List<org.sakaiproject.authoring.panel.RolePart> list) {
		super(list, Bundle.getString("title.rolepart"));
	}
	
	 
	public void RolePartSelectionModel(
			List<org.sakaiproject.authoring.panel.RolePart> list) {
	...
	public Object getValueAt(int rowIndex, int columnIndex) {
		if(columnIndex == 0){
			...
			String roleTitle = getTitle(((Object) rolePart.getRoleRef()).getRef());
