...
public class AuthoringGraphFactory {
	...
	public static DefaultGraphCell createDefaultCell(Object data, Point location){
	...
	public static JGraph createDefaultGraph(KeyListener keyListener, 
		...
		Object model = new DefaultGraphModel();
	...
	public static DefaultGraphCell createDefaultGroupCell(JGraph graph, Object[] children, String title) {
		...
		if (children != null && children.length > 0) {
			...
			if (group != null && children != null && children.length > 0) {
				...
				((Object) graph.getGraphLayoutCache()).insert(new Object[] { group },
						null, null, pm);
			}
			return group;
		}
