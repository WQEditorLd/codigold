...
public class ComponentsModel {
	...
	public Object getComponentWithIdentifier(String objectIdentifier) {
		...
		component = getActivityWithIdentifier(objectIdentifier);
		if(component != null){
			return component;
		}
	...
	public Object getActivityWithIdentifier(String oID) {
		return activitiesModel.getActivityWithIdentifier(oID);
	}
